                ...
                <div className="category-tab-heading-wrapper">
                  ...
                  <div className="etabs">
                    <ul className="nav nav-tabs">
                      <li className="active"><a onclick="comihuredkloadAjaxData('33')" href="#All collection" data-toggle="tab">All
													collection</a></li>
                      <li><a onclick="comihuredkloadAjaxData('44')" href="#New arrivals" data-toggle="tab">New arrivals</a></li>
                      <li><a onclick="comihuredkloadAjaxData('47')" href="#Top rated" data-toggle="tab">Top rated</a></li>
                      <li><a onclick="comihuredkloadAjaxData('48')" href="#Best Seller" data-toggle="tab">Best Seller</a></li>
                    </ul>
                  </div>
                </div>
                <div className="tabs">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('47 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('47 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('47 ');">
                              ...
                              <div className="product-block-inner">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('48 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('48 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('48 ');">
                                        <i className="fa fa-clone"></i>
                                        Add to Compare
																			</button>
                                      <div className="quickview">
                              ...
                              <div className="product-block-inner">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('43 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('43 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('43 ');">
                                        <i className="fa fa-clone"></i>
                                        Add to Compare
																			</button>
                                      <div className="quickview">
                              ...
                              <div className="product-block-inner">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('31 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('31 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('31 ');">
                                        <i className="fa fa-clone"></i>
                                        Add to Compare
																			</button>
                                      <div className="quickview">
                              ...
                              <div className="product-block-inner">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('33 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('33 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('33 ');">
                                        <i className="fa fa-clone"></i>
                                        Add to Compare
																			</button>
                                      <div className="quickview">
                              ...
                              <div className="product-block-inner">
                                ...
                                <div className="caption">
                                  <div className="product-deacription-wrapper">
                                    ...
                                    <div className="button-group">
                                      <button type="button" className="btn btn-primary addtocart" onclick="cart.add('46 ');">
                                        <i className="fa fa-shopping-basket"></i>
                                        Add to Cart
																			</button>
                                      <button className="btn btn-primary wishlist" type="button" onclick="wishlist.add('46 ');">
                                        <i className="fa fa-heart"></i>
                                        Add to Wish List
																			</button>
                                      <button className="btn btn-primary compare" type="button" onclick="compare.add('46 ');">
                                        <i className="fa fa-clone"></i>
                                        Add to Compare
																			</button>
                                      <div className="quickview">
                    ...
                    <form method="post">
                      <div className="form-group required">
                        <div className="input-news">
                          <input type="email" name="txtemail" id="txtemail" value="" placeholder="Enter Your Email" className="form-control input-lg" />
                        </div>
                        <div className="subscribe-btn">
                          <button type="submit" className="btn btn-default btn-lg" onclick="return subscribe();">Subscribe</button>
                        </div>
                      </div>
                    </form>
                  </div>
