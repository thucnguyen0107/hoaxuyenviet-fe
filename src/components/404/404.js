        ...
        <div className="container">
          <div className="row">
            <ul className="breadcrumb">
              ...
              <li><Link to="/home" style={{ pointerEvents: 'inherit' }}>Trở về trang chủ</Link></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div id="product-category" className="container">
          <div className="row">
            <div id="content" className="col-sm-12 categorypage">
              <img style={{ display: 'block', margin: '0 auto' }} className="img-responsive" src={NotFoundImg} alt="404 Not Found" />
            </div>
          </div>
        </div>
      </div>
