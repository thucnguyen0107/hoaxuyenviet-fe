...
const tabCategoryContent = (props) => {
    ...
    console.log(props.tabCategoryContent);
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="indexd21c.html?route=product/product&amp;product_id=47">
                                            <img src={props.tabCategoryContent[0].srcImg} title="HP LP3065" alt="HP LP3065" className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[2].srcImg} title="HP LP3065"
                                                alt="HP LP3065" />
                                        </a>
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="indexb77e.html?route=product/product&amp;product_id=48">
                                            <img src={props.tabCategoryContent[1].srcImg} title="iPod classNameic" alt="iPod classNameic"
                                                className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[3].srcImg} title="iPod classNameic"
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="indexb8ca.html?route=product/product&amp;product_id=43">
                                            <img src={props.tabCategoryContent[2].srcImg} title="MacBook" alt="MacBook" className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[4].srcImg} title="MacBook"
                                                alt="MacBook" />
                                        </a>
                                        <div className="extra-info">
                                        </div>
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="indexbfcf.html?route=product/product&amp;product_id=31">
                                            <img src={props.tabCategoryContent[3].srcImg} title="Nikon D300" alt="Nikon D300" className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[5].srcImg} title="Nikon D300"
                                                alt="Nikon D300" />
                                        </a>
                                        <div className="extra-info">
                                        </div>
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="index6a4d.html?route=product/product&amp;product_id=33">
                                            <img src={props.tabCategoryContent[4].srcImg} title="Samsung SyncMaster 941BW" alt="Samsung SyncMaster 941BW"
                                                className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[6].srcImg} title="Samsung SyncMaster 941BW"
                                ...
                                <div className="product-block-inner">
                                    <div className="image">
                                        <a href="index2ebe.html?route=product/product&amp;product_id=46">
                                            <img src={props.tabCategoryContent[5].srcImg} title="Sony VAIO" alt="Sony VAIO" className="img-responsive reg-image" />
                                            <img className="img-responsive hover-image" src={props.tabCategoryContent[7].srcImg} title="Sony VAIO"
                                                alt="Sony VAIO" />
                                        </a>
                                        <div className="extra-info">
                                        </div>
